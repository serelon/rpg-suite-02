...
| [[0031-beware-transient-constraint-architecture]] | pattern | solorpg/new | Don't architect around transient model limits; the multi-agent postprocess died when 165k→1M. |
