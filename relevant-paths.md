...
| [[0085-knowledge-entries-vs-tool-data]] | principle | conversation | The KB's first type cut: knowledge entries (one base shape + treatment flags — memories, stories, transcripts, texture banks) vs tool data (namesets, pools — the tool's output is the context snippet). |
